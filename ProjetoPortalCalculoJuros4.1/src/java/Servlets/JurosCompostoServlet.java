    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                out.println("<h2>Detalhes do cálculo - Juros Composto</h2><hr>");
                out.println("<h3>Valor inicial: "+valpresente+"</h3>");
                out.println("<h3>Taxa de juros aplicada: "+((int)taxjuros)+"</h3>");
                out.println("<h3>Tempo da aplicação: "+((int)tempo)+"</h3>");
                valfinal = (valpresente * Math.pow((1+(taxjuros/100)),tempo));
